...
export const ArtifactsStep: React.FC = () => {
  return (
    <div className="animate-in fade-in">
      <Section title="Technical Documentation" subtitle="Buyer Guidance">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col p-6 rounded-card border border-divider bg-bg-page/20 border-dashed items-center justify-center cursor-pointer hover:border-brand transition-all group">
            <FileText size={32} className="text-text-tertiary group-hover:text-brand mb-3 opacity-40" />
            <span className="text-sm font-bold text-text-secondary">Upload PDF/MD Docs</span>
          </div>
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between p-3 rounded-control border border-divider bg-bg-card">
              <div className="flex items-center gap-3">
                <FileText size={16} className="text-text-tertiary" />
                <span className="text-xs font-bold text-text-primary">Implementation_Guide.pdf</span>
              </div>
      ...
      <Section title="Visual Examples" subtitle="Storefront Preview">
        <Row gutter={[16, 16]}>
          <Col span={6}>
